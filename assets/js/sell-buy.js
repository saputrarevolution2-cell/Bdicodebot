...
(async()=>{if(!await protectPage())return;document.getElementById('sellForm')?.addEventListener('submit',e=>{e.preventDefault();const m=document.getElementById('sellMsg');m.textContent='Draft code tersimpan di tampilan.';m.style.display='block'})})();
