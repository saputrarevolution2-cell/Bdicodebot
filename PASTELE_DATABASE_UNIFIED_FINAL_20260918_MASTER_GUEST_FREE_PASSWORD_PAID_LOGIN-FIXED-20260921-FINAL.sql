...
-- ============================================================
-- ============================================================
-- PasteLink password function cleanup.
-- Use explicit signatures; do not enumerate pg_proc dynamically.
-- This avoids compatibility issues in Supabase SQL Editor.
-- ============================================================
...
-- ============================================================
-- FINAL PASSWORD HASH AUDIT
-- No dynamic pg_proc loop is used here.
-- The canonical functions below explicitly call extensions.digest().
-- ============================================================
SELECT
  public.create_pastelink_content IS NOT NULL AS create_pastelink_rpc_present
FROM (
  SELECT to_regprocedure(
    'public.create_pastelink_content(text,text,text,text,numeric,text,text[],timestamptz,text)'
  ) AS create_pastelink_content
) q;
