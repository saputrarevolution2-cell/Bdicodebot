document.addEventListener('DOMContentLoaded', async () => {
 ...
 const savedTheme=localStorage.getItem('pastele-theme'); if(savedTheme==='dark') document.body.classList.add('theme-dark');
 const themeBtn=document.getElementById('navTheme'); themeBtn?.addEventListener('click',()=>{const dark=document.body.classList.toggle('theme-dark');localStorage.setItem('pastele-theme',dark?'dark':'light');const i=themeBtn.querySelector('i');if(i)i.className='fa-solid '+(dark?'fa-sun':'fa-moon')});
