/* PasTele — self-contained view-code page script. One HTML -> one JS -> one CSS. */
...
async function loadSocial(kind,item){
 ...
 const [counts,likes,comments,u]=await Promise.all([
   window.PasTeleDB.rpc("get_content_engagement_counts",{p_target_id:tid,p_target_type:tt}),
 ...
 $("shareBtn")?.addEventListener("click",async()=>{
   ...
   try{await window.PasTeleDB.rpc("record_quest_event",{p_event_type:"share"})}catch{}
