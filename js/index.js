/* PasTele theme bootstrap — page-local JS */
(()=>{try{const m=localStorage.getItem('pastele-theme')||'auto';const d=m==='dark'||(m==='auto'&&window.matchMedia('(prefers-color-scheme:dark)').matches);document.documentElement.dataset.theme=d?'dark':'light';}catch(e){}})();
