window.Auth={
 lookup:async identifier=>{
  if(!sb) throw Error('Supabase belum dikonfigurasi. periksa js/config.js.');
 ...
 login:async(identifier,password)=>{
  ...
  if(profile?.is_banned){await sb.auth.signOut();throw Error('Akun ini sedang dinonaktifkan oleh admin.');}
