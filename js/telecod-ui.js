...
"Masuk":"Masuk","Daftar Akun":"Daftar Akun","Kembali ke TeleCod":"Kembali ke TeleCod","Aman, cepat & mudah.":"Aman, cepat & mudah.","Masukkan Gmail atau username untuk melanjutkan.":"Masukkan Gmail atau username untuk melanjutkan.","Gmail / Username":"Gmail / Username","Masukkan Gmail / username":"Masukkan Gmail / username","Lanjutkan":"Lanjutkan","Kata Sandi":"Kata Sandi","Masukkan kata sandi":"Masukkan kata sandi","Login / Masuk":"Login / Sign in","Lupa kata sandi? Reset kata sandi":"Forgot password? Reset password","Belum punya akun?":"Don’t have an account?","Daftar / Register sekarang":"Register now","Buat akun TeleCod menggunakan username, Gmail, dan kata sandi.":"Create a TeleCod account with username, Gmail, and password.","Buat username":"Create username","Masukkan Gmail":"Enter Gmail","Buat kata sandi":"Create password","Konfirmasi Kata Sandi":"Confirm Password","Konfirmasi kata sandi":"Confirm password","Daftar / Register":"Register","Daftar dengan Gmail":"Register with Gmail"
},
en:{
...
document.addEventListener('DOMContentLoaded',()=>{apply();tr();translateAll();bell();document.querySelectorAll("#themeBtn").forEach(b=>b.addEventListener("click",()=>window.TeleCodUI?.toggleTheme()));new MutationObserver(()=>translateAll()).observe(document.body,{subtree:true,childList:true});window.addEventListener('storage',e=>{if(e.key==='telecod_lang'){apply();tr();translateAll()}})});
})();
