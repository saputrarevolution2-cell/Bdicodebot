...
on("#featurePasteBtn","click",()=>openEditor());on("#featureSellBtn","click",()=>openMarketplaceCreateModal("code"));on("#featureDashboardBtn","click",()=>location.href="/dashboard/");on("#featureWithdrawBtn","click",()=>location.href="/dashboard/?page=payment");on("#featureLanguageBtn","click",()=>$("#langBtn")?.click());
