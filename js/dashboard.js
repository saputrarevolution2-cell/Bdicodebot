...
function layoutReady(){
 ...
 $('#logoutBtn').onclick=async e=>{e.preventDefault();if(sup)await sup.auth.signOut();location.href='/index.html'};$('#userBtn').onclick=()=>location.href='/dashboard?page=profile';$('#notifBtn').onclick=()=>window.TeleCodNotifications?.toggle();setTheme();applyLang();
}
