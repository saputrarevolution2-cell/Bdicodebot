...
const state={user:null,profile:{},lang:localStorage.getItem('telecod_lang')||'id',theme:localStorage.getItem('telecod_theme')||'light'};
const T={
...
function setTheme(){document.documentElement.dataset.theme=state.theme;document.documentElement.classList.toggle('light',state.theme==='light');document.body.classList.toggle('light',state.theme==='light');localStorage.setItem('telecod_theme',state.theme);}
...
async function renderPayment(){
  ...
  $('#content').innerHTML=`
    ...
    <p class="page-sub">${tr('pendingHint')}</p></div></div>
    <div class="grid three">
      <div class="card"><div class="stat-label">${tr('availableBalance')}</div><div class="balance">${money(available)}</div></div>
      <div class="card"><div class="stat-label">${tr('pendingBalance')}</div><div class="balance">${money(pending)}</div><div class="help">${tr('pendingHint')}</div></div>
