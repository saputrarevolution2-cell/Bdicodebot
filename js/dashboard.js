...
function layoutReady(){
 ...
 $('#logoutBtn').onclick=async e=>{e.preventDefault();if(sup)await sup.auth.signOut();location.href='index.html'};$('#userBtn').onclick=()=>location.href='/dashboard?page=profile';$('#notifBtn').onclick=()=>toast(state.lang==='id'?'Tidak ada notifikasi baru.':'No new notifications.');setTheme();applyLang();
}
