/* PasTele — self-contained create-code page script. One HTML -> one JS -> one CSS. */
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  $("createForm")?.addEventListener("submit", async (event) => {
    ...
    try {
      ...
      /*
       * ACCESS CONTRACT:
       * - FREE: guest maupun user login boleh membuat Code.
       *   Tidak ada login guard dan tidak perlu session untuk Free.
       * - PAID: wajib login. Session hanya diperiksa ketika Paid dipilih.
       *   Database/RPC tetap menjadi lapisan validasi terakhir.
       */
      const user = values.access === "paid" ? await getCurrentUser() : null;
