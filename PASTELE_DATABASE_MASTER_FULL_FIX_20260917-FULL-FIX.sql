...
-- ============================================================
-- ============================================================
-- 5. Unified public metrics view — SECURITY INVOKER SAFE
--
-- The view itself MUST NOT be SECURITY DEFINER.
-- Aggregate counts are calculated by a narrowly scoped SECURITY
-- DEFINER helper which validates the target before counting.
-- This prevents RLS on likes/comments/analytics from making the
-- public counters read as zero while keeping the view invoker-safe.
-- ============================================================
